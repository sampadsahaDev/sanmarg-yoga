...
const courses=[
    {
        ...
        details: 'Our Studio Regular Batch offers an immersive environment for yoga enthusiasts of all levels. Build strength, enhance flexibility, and achieve mindfulness with personalized guidance.',
        img:`url(photos/studio.jpg)`,

    },
    {
        heading:'Our Teacher Training Program',
        details: 'This program is designed for aspiring yoga instructors. Gain a deep understanding of yoga philosophy, anatomy, and teaching techniques to share the art of yoga with others confidently.',        img:`url(photos/studio.webp)`, /*change this*/

    },
    
    {
        heading:'Online classes ',
        details: 'Enjoy the flexibility of practicing yoga from the comfort of your home. Our online classes cater to all levels and include live sessions with expert instructors.',        img:`url(photos/online.jpg)`,
